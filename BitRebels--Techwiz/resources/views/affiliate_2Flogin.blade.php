...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=affiliate/login" />
  </form>
</div>
</li>
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="well">
            ...
            <a class="btn btn-primary" href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=affiliate/register">Continue</a></div>
        </div>
        <div class="col-sm-6">
          <div class="well">
            <h2>Affiliate Login</h2>
            <p><strong>I am a returning affiliate.</strong></p>
            <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=affiliate/login" method="post" enctype="multipart/form-data">
