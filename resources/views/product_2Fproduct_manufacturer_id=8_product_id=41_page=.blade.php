...
<link href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;product_id=41" rel="canonical" />
...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=41&amp;page=" />
  </form>
</div>
</li>
...
<div id="product-product" class="container product-product">
  <ul class="breadcrumb">
        ...
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;page=&amp;product_id=41">magni dolores eosquies</a></li>
      </ul>
  <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 product-images">
          ...
          <div class="thumbnails">
			  ...
			  <img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/05-570x741.jpg" title="magni dolores eosquies" data-zoom-image="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/05-800x1040.jpg" alt="magni dolores eosquies" />
...
$(".additional-images-container .customNavigation").addClass('owl-navigation');
		...
		<table class="product-info">
                        ...
                        <tr><td>Product Code:</td><td class="product-info-value">Product 14</td></tr>
          ...
          <div class="btn-group">
            <button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('41');"><i class="fa fa-heart"></i>
			Add to Wish List 
			</button> 
            <button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('41');"><i class="fa fa-exchange"></i>
			Add to compare
			</button>
          </div>
		  <!-- Product Wishlist Compare END -->
            ...
            <div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;product_id=41"><a class="addthis_button_facebook_like" fb:like:layout="button_count"></a> <a class="addthis_button_tweet"></a> <a class="addthis_button_pinterest_pinit"></a> <a class="addthis_counter addthis_pill_style"></a></div>
