...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/login" />
  </form>
</div>
</li>
...
<div class="header-content-title">
	<div style="background-image: url('../assets/image/catalog/demo/banners/parallax.jpg'); background-position: 50% 78.1106%;" data-source-url="../../OPC190_nursery/OPC02/image/catalog/demo/banners/parallax.jpg" class="parallex">
	</div>
</div>
...
<div id="account-login" class="container">
  <ul class="breadcrumb">
        ...
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/account">Account</a></li>
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/login">Login</a></li>
      </ul>
      <div class="row">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="well">
            ...
            <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/register" class="btn btn-primary">Continue</a></div>
        </div>
        <div class="col-sm-6">
          <div class="well">
            <h2>Returning Customer</h2>
            <p><strong>I am a returning customer</strong></p>
            <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/login" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/forgotten">Forgotten Password</a></div>
              <input type="submit" value="Login" class="btn btn-primary" />
                            <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/edit" />
                          </form>
          </div>
        </div>
      </div>
