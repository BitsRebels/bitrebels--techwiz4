...
<title>Lorem ipsum dolor site amet</title>
<base href="../assets/" />
...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=information/tt_blog&amp;tt_blog_id=1" />
  </form>
</div>
</li>
...
<div id="module-ttblog-details" class="container blog-blog">
  <ul class="breadcrumb">
        ...
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=information/tt_blog&amp;tt_blog_id=1">Lorem ipsum dolor site amet</a></li>
      </ul>
  <div class="row">
...
<div class="panel-heading">Information</div>
  <div class="list-group">
    ...
    <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=information/sitemap" class="list-group-item">Site Map</a>
      ...
      <h1>Lorem ipsum dolor site amet</h1>
	  <div class="blog-post">
		  				<div class="blog_image_holder">
					<img itemprop="image" src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/banners/1-home-default-870x564.jpg" alt="Lorem ipsum dolor site amet" title="Lorem ipsum dolor site amet" class="imageFeatured" />
				</div>
		  	    <div class="blog-detail-content">
	  	<div class="page-item-title"><h1>Lorem ipsum dolor site amet</h1></div>
		<div class="blog-tool">
			<span class="date-time">27/10/2020</span>
			<!--<div class="comment"> <i class="fa fa-comments-o"></i> <?php echo $blogs['total_comments']; ?></div> #}-->
		</div>
		<div class="article-desc"> <p>					  					  					  					  Lorem Ipsum is simply dummy text of the printing and typesetting industry.
	  ...
	  <div class="blog-extra">
		  ...
		  <div id="add-comment">
							<div class="login-required alert alert-info"><i class="fa fa-info-circle"></i> You must <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/login">login</a> to add a comment. If you do not have an account, you may free to <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/register">register</a> for one.</div>
