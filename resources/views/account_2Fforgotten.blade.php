...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/forgotten" />
  </form>
</div>
</li>
...
<div id="account-forgotten" class="container">
  <ul class="breadcrumb">
        ...
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/forgotten">Forgotten Password</a></li>
      </ul>
    <div class="row">
      ...
      <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/forgotten" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
        ...
        <div class="buttons clearfix">
          <div class="pull-left"><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/login" class="btn btn-default">Back</a></div>
