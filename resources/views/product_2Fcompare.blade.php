...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/compare" />
  </form>
</div>
</li>
...
<div id="product-compare" class="container">
  <ul class="breadcrumb">
        ...
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/compare">Product Comparison</a></li>
      </ul>
    <div class="row">
      ...
      <div class="buttons">
        <div class="pull-right"><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/home" class="btn btn-default">Continue</a></div>
      </div>
            <script>
