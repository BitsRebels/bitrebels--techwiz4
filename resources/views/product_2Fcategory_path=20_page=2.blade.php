...
<link href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=20&amp;page=2" rel="canonical" />
<link href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=20" rel="prev" />
...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=20&amp;page=2" />
  </form>
</div>
</li>
 ...
 shoes, accessories, printed t-shirts, feminine dresses, women's jeans!</p></div>
      ...
      <div class="row">
          ...
          <div class="product-thumb row">
            <div class="image">
								<a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=35">
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-wishlist" title="Add to Wish List"  onclick="wishlist.add('35');"><i class="fa fa-heart"></i>
				<span title="Add to Wish List">Add to Wish List</span>
				</button>
				<button class="btn-compare" title="Add to compare"  onclick="compare.add('35');"><i class="fa fa-exchange"></i>
				<span title="Add to compare">Add to compare</span>
				</button>
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=35')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=35">sint incidunt utlabore</a></h4>
               				<div class="rating no-rating">
			  			  			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
          ...
          <div class="product-thumb row">
            <div class="image">
								<a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=33">
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-wishlist" title="Add to Wish List"  onclick="wishlist.add('33');"><i class="fa fa-heart"></i>
				<span title="Add to Wish List">Add to Wish List</span>
				</button>
				<button class="btn-compare" title="Add to compare"  onclick="compare.add('33');"><i class="fa fa-exchange"></i>
				<span title="Add to compare">Add to compare</span>
				</button>
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=33')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=33">tempora incidunt utlabore</a></h4>
               				<div class="rating no-rating">
			  			  			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
          ...
          <div class="product-thumb row">
            <div class="image">
								<a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=46">
			...
			<div class="button-group">
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=46')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=46">voluptas nulla pariatur</a></h4>
               				<div class="rating no-rating">
			  			  			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
          ...
          <div class="product-thumb row">
            <div class="image">
								<a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=48">
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=48')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=48">voluptas sit aspernatur</a></h4>
               				<div class="rating no-rating">
			  			  			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
          ...
          <div class="product-thumb row">
            <div class="image">
								<a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=40">
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=40')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;path=20&amp;product_id=40">voluptate velit esse</a></h4>
               				<div class="rating no-rating">
			  			  			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
			  			   			  			  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
      ...
      <div class="category-pagination">
        <div class="col-xs-6 text-left">Showing 10 to 14 of 14 (2 Pages)</div>
        <div class="col-xs-6 text-right"><ul class="pagination"><li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=20">|&lt;</a></li><li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=20">&lt;</a></li><li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=20">1</a></li><li class="active"><span>2</span></li></ul></div>
      </div>
