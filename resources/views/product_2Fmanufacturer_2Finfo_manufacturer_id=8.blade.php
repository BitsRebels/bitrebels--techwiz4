...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/manufacturer/info&amp;manufacturer_id=8" />
  </form>
</div>
</li>
...
<div id="product-manufacturer" class="container">
  <ul class="breadcrumb">
        ...
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/manufacturer/info&amp;manufacturer_id=8">Apple</a></li>
      </ul>
...
<div class="panel-heading">Information</div>
  <div class="list-group">
      ...
      <div class="row">
          ...
          <div class="product-thumb row">
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=42')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=42">aliquam quaerat voluptatem</a></h4>
				 					<div class="rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
          ...
          <div class="product-thumb row">
            <div class="image">
			  <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=41"><img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/05-385x501.jpg" alt="magni dolores eosquies" title="magni dolores eosquies" class="img-responsive" /></a>
			  			    <div class="sale-icon">Sale</div>
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=41')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=41">magni dolores eosquies</a></h4>
				 					<div class="rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
          ...
          <div class="product-thumb row">
            <div class="image">
			  <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=36"><img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/06-385x501.jpg" alt="neque porro quisquam" title="neque porro quisquam" class="img-responsive" /></a>
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=36')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=36">neque porro quisquam</a></h4>
				 					<div class="rating no-rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
		...
		Its the small iPod with one very big idea: video. The worlds most popula..</p>
          ...
          <div class="product-thumb row">
            <div class="image">
			  <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=34"><img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/07-385x501.jpg" alt="neque porro quisquamest" title="neque porro quisquamest" class="img-responsive" /></a>
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=34')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=34">neque porro quisquamest</a></h4>
				 					<div class="rating no-rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
		...
		Clip on the worlds most wearable music player and take up to 240 songs with y..</p>
          ...
          <div class="product-thumb row">
            <div class="image">
			  <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=32"><img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/08-385x501.jpg" alt="nostrum exercitationem" title="nostrum exercitationem" class="img-responsive" /></a>
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=32')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=32">nostrum exercitationem</a></h4>
				 					<div class="rating no-rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
	...
	iPod touch features the same multi-touch screen technology as..</p>
          ...
          <div class="product-thumb row">
            <div class="image">
			  <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=43"><img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/09-385x501.jpg" alt="perspiciatis unde omnis" title="perspiciatis unde omnis" class="img-responsive" /></a>
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=43')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=43">perspiciatis unde omnis</a></h4>
				 					<div class="rating no-rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
		...
		Powered by an Intel Core 2 Duo processor at speeds up to 2.16GHz, t..</p>
          ...
          <div class="product-thumb row">
            <div class="image">
			  <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=44"><img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/10-385x501.jpg" alt="quaerat outt voluptatem" title="quaerat outt voluptatem" class="img-responsive" /></a>
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=44')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=44">quaerat outt voluptatem</a></h4>
				 					<div class="rating no-rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
          ...
          <div class="product-thumb row">
            <div class="image">
			  <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=45"><img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/11-385x501.jpg" alt="quis autem veleuminium" title="quis autem veleuminium" class="img-responsive" /></a>
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=45')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=45">quis autem veleuminium</a></h4>
				 					<div class="rating no-rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
          ...
          <div class="product-thumb row">
            <div class="image">
			  <a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=48"><img src="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/image/cache/catalog/demo/product/18-385x501.jpg" alt="voluptas sit aspernatur" title="voluptas sit aspernatur" class="img-responsive" /></a>
			...
			<i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart
				...
				<button class="btn-quickview" type="button" title="Quick View" onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=48')"><i class="fa fa-eye"></i>
					<span title="Quick View">Quick View</span>
			</button>
              </div>
            ...
            <div class="thumb-description">
              <div class="caption">
				<h4><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/product&amp;manufacturer_id=8&amp;product_id=48">voluptas sit aspernatur</a></h4>
				 					<div class="rating no-rating">
				  				  				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
				  				   				  				  <span class="fa fa-stack"><i class="fa fa-star off fa-stack-2x"></i></span>
