...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=87" />
  </form>
</div>
</li>
...
<div id="product-category" class="container product-category">
  <ul class="breadcrumb">
        ...
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=87">Rose Creek</a></li>
      </ul>
		  ...
		  <div class="row">
			<div class="col-sm-12">
			  <ul>
					...
					<h5><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=87_91">Autumn</a></h5>
				</li>
								<li>
					<div class="subcategory-image">
											</div>
					<h5><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=87_90">Grandifolius</a></h5>
				</li>
								<li>
					<div class="subcategory-image">
											</div>
					<h5><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=87_88">Green Boxleaf</a></h5>
				</li>
								<li>
					<div class="subcategory-image">
											</div>
					<h5><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=87_97">Raulston's Gold</a></h5>
				</li>
							  </ul>
			</div>
		  </div>
