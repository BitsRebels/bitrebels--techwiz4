...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=92" />
  </form>
</div>
</li>
...
<div id="product-category" class="container product-category">
  <ul class="breadcrumb">
        ...
        <li><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=92">Canyon Creek</a></li>
      </ul>
		  ...
		  <div class="row">
			<div class="col-sm-12">
			  <ul>
					...
					<h5><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=92_96">Abelia</a></h5>
				</li>
								<li>
					<div class="subcategory-image">
											</div>
					<h5><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=92_94">Ajuga</a></h5>
				</li>
								<li>
					<div class="subcategory-image">
											</div>
					<h5><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=92_95">Aucuba</a></h5>
				</li>
								<li>
					<div class="subcategory-image">
											</div>
					<h5><a href="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=product/category&amp;path=92_93">Coreopsis</a></h5>
				</li>
							  </ul>
			</div>
		  </div>
