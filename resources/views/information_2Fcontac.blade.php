...
<div class="full-header">
 ...
 <span class="ttuserheading">my account</span><i class="fa fa-caret-down"></i></a>
  ...
  <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=information/contact" />
  </form>
</div>
</li>
...
Varachha Road,Surat
                            ...
                            <a href="https://maps.google.com/maps?q=21.227628%2C72.8631923&hl=en-gb&t=m&z=15" target="_blank" class="btn btn-info"><i class="fa fa-map-marker"></i> View Google Map</a>
                          </div>
			...
			<div class="location-detail"> 123456789 </div>
                            <div class="location-title"><i class='fa fa-fax'></i> Fax </div>
            ...
            <div class="col-sm-3 store-status">
              ...
              <div class="location-detail"> Monday To Saturday<br />
9:00AM to 7:00PM </div>
            ...
            <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=information/contact" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
