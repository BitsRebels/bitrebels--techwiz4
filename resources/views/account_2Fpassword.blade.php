...
<div class="header-content-title">
	<div style="background-image: url('../assets/image/catalog/demo/banners/parallax.jpg'); background-position: 50% 78.1106%;" data-source-url="../assets/image/catalog/demo/banners/parallax.jpg" class="parallex">
	</div>
</div>
          ...
          <div class="well">
            ...
            <form action="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/login" method="post" enctype="multipart/form-data">
              ...
              <input type="submit" value="Login" class="btn btn-primary" />
                            <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC07/OPC190_nursery/OPC02/index.php?route=account/password" />
                          </form>
          </div>
        </div>
      </div>
